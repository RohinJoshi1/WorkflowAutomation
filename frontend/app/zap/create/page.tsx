            ...
            <PrimaryButton onClick={async () => {
                ...
                try {
                    const response = await axios.post(`${BACKEND_URL}/api/v1/zap`, {
                        "availableTriggerId": selectedTrigger.name,
                        "triggerMetadata": {},
        ...
        <div className="relative p-4 w-full max-w-2xl max-h-full">
            <div className="relative bg-white rounded-lg shadow ">
                ...
                <div className="p-4 md:p-5 space-y-4">
                    {step === 1 && selectedAction?.name === "send_mail" && <EmailSelector setMetadata={(metadata) => {
                        onSelect({
                            ...selectedAction,
                            metadata
                        })
                    ...
                    {(step === 1 && selectedAction?.name === "send_eth") && <SolanaSelector setMetadata={(metadata) => {
                        onSelect({
                            ...selectedAction,
                            metadata
                        })
